...
// Theme-agnostic markdown renderers — all colours are DaisyUI semantic tokens
...
export default function ProjectTabs({ breadcrumb, markdown, tryIt }: Props) {
  ...
  return (
    <div className="mx-auto max-w-4xl py-8">
      ...
      <div role="tablist" className="tabs tabs-bordered mb-8">
        ...
        <button
          role="tab"
          className={`tab ${activeTab === "try-it" ? "tab-active" : ""}`}
      ...
      {activeTab === "try-it" && (tryIt ?? <RagChat />)}
    </div>
  );
}
